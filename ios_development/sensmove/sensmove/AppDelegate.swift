...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        singletonDatas.getDatasFromFile("SMData", success: { (datas) -> () in
            ...
            printLog(error, funcName: "didFinishLaunchingWithOptions", logString: "Error while parsing datas from SMData")
        ...
        if(userService.asUserInKeychain()) {
            if(self.hasUnlockedPresentation()) {
                newController = storyboard.instantiateViewControllerWithIdentifier("sideMenuController") 
            } else {
                newController = storyboard.instantiateViewControllerWithIdentifier("presentationController") 
            }
            
        }else {
            newController = storyboard.instantiateViewControllerWithIdentifier("loginController") 
        }
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("sensmove", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("sensmove.sqlite")
